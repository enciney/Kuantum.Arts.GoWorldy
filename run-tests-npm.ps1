...
npm exec -- jest Tests/integration --forceExit --passWithNoTests

Write-Host "`nAPI unit tests..." -ForegroundColor Cyan
npm exec -- jest Tests/unit --forceExit --passWithNoTests
...
npm exec -- jest Tests/component --forceExit --passWithNoTests
